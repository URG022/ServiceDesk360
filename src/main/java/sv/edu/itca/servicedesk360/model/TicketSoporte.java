...
public class TicketSoporte {
    ...
    public TicketSoporte(long id, String titulo, String descripcion, Solicitante solicitante, PrioridadTicket prioridad) {
        ...
        this.id = id;
        this.titulo = obligatorio(titulo, "titulo");
    ...
    public void asignarTecnico(Tecnico tecnico) {
        ...
        if (!tecnico.puedeAtender(prioridad)) {
            throw new IllegalStateException("El técnico no puede atender esta prioridad.");
        }
    ...
    public void cambiarEstado(EstadoTicket nuevoEstado) {
        ...
        if (this.estado == EstadoTicket.CERRADO && nuevoEstado == EstadoTicket.EN_PROCESO) {
            throw new IllegalStateException("Un ticket CERRADO no puede cambiar directamente a EN_PROCESO.");
        }
